...
if (isset($_POST['submit'])) {
    ...
    $role_pengirim = 'admin'; // Asumsikan pengirim adalah admin
...
// Ambil semua pesan antara admin dan user dari database untuk ditampilkan
$query_pesan = "SELECT * FROM tb_chat WHERE (pengirim = 'admin' AND penerima = 'user') OR (pengirim = 'user' AND penerima = 'admin') ORDER BY waktu ASC";
    ...
    <div class="container mt-5">
        ...
        <form method="post" action="">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="pengirim" name="pengirim" value="admin" readonly>
            </div>
            <div class="form-group">
                <label for="penerima">Penerima:</label>
                <input type="text" class="form-control" id="penerima" name="penerima" value="user" readonly>
            </div>
            <div class="form-group">
        ...
        <div class="daftar-pesan">
            ...
            // Menampilkan semua pesan antara admin dan user dari database
            if (mysqli_num_rows($result_pesan) > 0) {
                ...
                echo '<p class="text-muted">Belum ada pesan antara admin dan user.</p>';
            }
            ?>
        </div>
    </div>
